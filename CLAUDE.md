...
### Typography
Choose fonts that are beautiful, unique, and interesting. Avoid generic fonts like Arial, Inter, Roboto, or system fonts. Opt for distinctive choices that elevate the UI. Pair a distinctive display font with a refined body font.
...
- Every design looking the same — vary between light/dark themes, fonts, aesthetics
